...
비밀번호확인 : <input type="password" name="memberPwCon"/><br/>
...
연락처1 : <input type="tel" name="memberPhone1"/><br/>
연락처2 : <input type="tel" name="memberPhone2"/><br/>
성별 : <input type="checkbox" name="gender" value="M"/> 남자
성별 : <input type="checkbox" name="gender" value="F"/> 여자 <br/>
