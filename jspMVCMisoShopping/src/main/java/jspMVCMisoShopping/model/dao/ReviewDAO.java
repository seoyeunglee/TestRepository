...
public class ReviewDAO extends DataBaseInfo{
	...
	public List<ReviewDTO> reviewSelectAll(String goodsNum){
		...
		con=getConnection();
		sql=" select review_num, review_content, review_date, member_id from reviews where goods_num = ? ";
		try {
	...
	public void reviewInsert(ReviewDTO dto) {
		...
		sql = "  merge into reviews r "
			...
			+ " 	insert (REVIEW_NUM, GOODS_NUM,PURCHASE_NUM,REVIEW_DATE,REVIEW_CONTENT,MEMBER_ID ) "
